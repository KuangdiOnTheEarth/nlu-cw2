    ...
    def forward(self, tgt_inputs, encoder_out, incremental_state=None):
        ...
        for j in range(tgt_time_steps):
            ...
            2.  How is attention integrated into the decoder? 
                The attention mechanism encodes some context information into the hidden state generated by the LSTM block.
            ...
            3.  Why is the attention function given the previous target state as one of its inputs?
                ...
                how to distribute attention to each encoder hidden states at current decoder time step.
            4.  What is the purpose of the dropout layer?
                The dropout layer randomly zeroes the values in some units, which is a way of regularization.
                This operation introduced some random noises into the training process, 
                the randomized zeros will break out the dependency between some units of different layers,
                which helps prevent layers co-adapt to correct some mistakes generated by previous layers.
                As a result, dropout layer can reduce the probability of over-fitting and make the trained model more robust.
            '''
            if self.attention is None:
                ...
                # attn_weights.size = [batch_size, tgt_time_steps, src_time_steps]
